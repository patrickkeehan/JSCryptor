(function() {
  ...
  var _encrypt = function(plain_text, components, encryption_key, hmac_key) {
    ...
    var algorithm = cryptian.algorithm.Rijndael128();
    algorithm.setKey(encryption_key);

    var cipher = cryptian.mode.cbc.Cipher(algorithm, components.headers.iv);
  ...
  RNCryptor.Decrypt = function(b64str, password) {
    ...
    var cipher = cryptian.mode.cbc.Decipher(algorithm, components.headers.iv);
